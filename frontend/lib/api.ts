...
export const protokolerApi = {
  ...
  get: async (id: string) => { await delay(300); return { id, nama_lengkap: "Dummy User" }; },
  create: async (data: any) => { await delay(500); return { success: true, id: "new-p" }; },
  update: async (id: string, data: any) => { await delay(500); return { success: true }; },
  remove: async (id: string) => { await delay(500); return { success: true }; },
};
...
export const kegiatanApi = {
  ...
  create: async (data: any) => { await delay(500); return { success: true, id: "new-k" }; },
  update: async (id: string, data: any) => { await delay(500); return { success: true }; },
  remove: async (id: string) => { await delay(500); return { success: true }; },
};
...
export const pendaftaranApi = {
  byKegiatan: async (kegiatan_id: string) => { await delay(400); return []; },
  byProtokoler: async (protokoler_id: string) => { await delay(400); return []; },
  create: async (data: any) => { await delay(500); return { success: true }; },
  update: async (id: string, data: any) => { await delay(500); return { success: true }; },
  remove: async (id: string) => { await delay(500); return { success: true }; },
};
...
export const regulasiApi = {
  list: async () => { await delay(400); return []; },
  create: async (data: any) => { await delay(500); return { success: true }; },
};
